...
function About() {
  return (
    <section className="my-container w-full min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 dark:from-gray-900 dark:via-black dark:to-gray-900 text-gray-700 dark:text-gray-300 transition-all duration-500 pt-6 pb-12 flex flex-col items-center">
      {/* Header */}
      <motion.div
      ...
      >
        <h2 className="text-4xl sm:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-400 text-center">
          About Me
        </h2>
        {/* <FloatingIcon /> */}
      </motion.div>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-16 w-full max-w-6xl">
        ...
        >
          <div className="group relative overflow-hidden rounded-[4px] shadow-2xl">
            <img
              src="/images/b-1/Homepage - Laptop/Image.svg"
              alt="Yeasin Arafat"
              className="w-full h-130 rounded-[4px] transform transition-transform duration-500 group-hover:scale-105"
            />
